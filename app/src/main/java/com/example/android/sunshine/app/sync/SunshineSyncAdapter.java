...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter
    ...
    public void onConnected(@Nullable Bundle bundle) {
        Log.d("*SyncAdapter", "onConnected");
    }

    @Override
    public void onConnectionSuspended(int i) {
        Log.d("*SyncAdapter", "onConnectionSuspended");
    }

    @Override
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Log.d("*SyncAdapter", "onConnectionFailed");
    }
        ...
        try {
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                if (i == 0) {
                    ...
                    mHigh = (int) high;
                    mLow = (int) low;
                    mWeatherIconId = Utility.getArtResourceForWeatherCondition(weatherId);
                }
            }
                ...
                .setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
                    ...
                    public void onResult(@NonNull DataApi.DataItemResult dataItemResult) {
                        if (dataItemResult.getStatus().isSuccess()) {
                            Log.d("*updateWear", "Success");
                        } else {
                            Log.d("*updateWear", "Error");
                        }
                    }
                });
    }
    ...
    @NonNull
    private Asset createIconAsset() {
        Bitmap bitmap = BitmapFactory.decodeResource(getContext().getResources(), mWeatherIconId);
